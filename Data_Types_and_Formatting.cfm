<article id="556b5719-cb71-45f7-b54c-d72a4f0d336f" class="page sans">
    ...
    <div class="page-body"><p id="b4443467-3eab-43e4-9472-6dbf064707ac" class="">Last week, we read an article
        ...
        concepts are very much alive and well here as well. For example, what is the difference between 123456789 and
        ...
        <p id="893d1297-acec-4161-b5f3-e97dcbb70f73" class="">There are some computer programs that are very strictly
            ...
            specifically say that THIS IS AN NUMBER. THIS IS A DATE. ColdFusion, however, has both a reputation and
            culture of trying to do things in an elegantly simple way. It really does try to make things as
            straightforward as possible (one of the reasons I love it). Therefore, you don&#x27;t need to announce to
        ...
        <ul id="58c9cdd2-a99d-488d-af30-b52ac4c66bca" class="bulleted-list">
            <li style="list-style-type:disc">#fish + 3# = variable [FISH] doesn&#x27;t exist</li>
        </ul>
        <p id="4dcd0023-ac22-4431-95b5-2c7db2d95de2" class="">In this case, it&#x27;s trying to treat the word &quot;fish&quot;
            as a variable and, since we haven&#x27;t covered those yet, we&#x27;ll gloss over that. SOOOOO, does that
            mean that we are forever, forced to look at numbers like 6234798723847932 with no commas, dollar signs or
        ...
        <p id="da83994f-13d9-4a45-bac2-c0d1bf2cc1ea" class=""><strong>Date Formatters</strong>- Dates are another of
            ...
            work you type #now()#. Whew! Complex, right! Of course it needs to be inside a &lt;cfoutput&gt; tag but you
        ...
        <p id="3da8d607-08b2-47cd-8566-7392c3bb93e7" class=""><strong>Exercise</strong>: There is a folder in your site
            called &quot;LearnCF&quot; which, in turn, has a folder called &quot;exercises&quot;. If it doesn't have a
            folder called "exercises", create it. Make a new web page called &quot;MyDate.cfm&quot; in that &quot;exercises&quot;
            folder. In the body tag, add &lt;cfoutput&gt;#now()#&lt;/cfoutput&gt;. Start up your local server and open
            this page. You should see the current date and time as a time stamp.</p>
        <p id="74570cca-5391-44e4-ac8c-cccdb217aa6c" class="">However, it&#x27;s usually not a good idea to make your
            ...
            documentation at<a href="https://wikidocs.adobe.com/wiki/display/coldfusionen/DateFormat">https://wikidocs.adobe.com/wiki/display/coldfusionen/DateFormat</a>has
            a list of the elements of a mask. For example, to make the common date notation for the US, you would type
