<article id="556b5719-cb71-45f7-b54c-d72a4f0d336f" class="page sans">
    ...
    <div class="page-body"><p id="b4443467-3eab-43e4-9472-6dbf064707ac" class="">Last week, we read an article
        ...
        <p id="893d1297-acec-4161-b5f3-e97dcbb70f73" class="">There are some computer programs that are very strictly
            ...
            specifically say that THIS IS A NUMBER. THIS IS A DATE. ColdFusion, however, has both a reputation and
...
<li style="list-style-type:disc">#'fish' + 3# = <cfoutput><cftry>#'fish' + 3#<cfcatch type="any"> #cfcatch.message# </cfcatch></cftry></cfoutput></li>
        ...
        <p id="4dcd0023-ac22-4431-95b5-2c7db2d95de2" class="">In this case, we told it to mathematically add a string ("fish") to a number (3) which
            is pretty much impossible and it says so. SOOOOO, does that mean that we are forever, forced to look at numbers like 6234798723847932 with no commas, dollar signs or
        ...
        <p id="3da8d607-08b2-47cd-8566-7392c3bb93e7" class=""><strong>Exercise</strong>: In this "learnCF" folder there is a folder
            called &quot;exercises&quot;. If it doesn't have a
            ...
            the /learncf/myDate.cfm page. You should see the current date and time as a time stamp.</p>
