<article id="6da953fd-8324-43e0-8dda-a5c469c36331" class="page sans">
    ...
    <div class="page-body"><p id="89476838-6da4-4880-8db1-27e0c8e06578" class="">In Week 2, we took a HTML page and
        ...
        separate that into it’s own files. This is called Separation of Concerns (<a
...
// Place your content here
    ...
    function anotherFunction(){
        ...
        <p id="ce254398-b2e2-4c52-a0a1-3722ba700817" class="">There can technically be any number of functions in your
            component but convention and "best practices" typically say to have around 10. That’s a guideline, not a
            "law". </p>
        <p id="314fb3d2-6d4f-4d0b-997f-797e654eede1" class="">
        </p>
        ...
        <p id="8d4686d1-860a-496c-9c03-830d98807a53" class="">
        </p>
        <pre id="58d4e651-d69a-4dcb-a59c-1768e49d2446" class="code"><code>&lt;html&gt;
    &lt;head&gt;
    &lt;/head&gt;
    &lt;body&gt;
...
&lt;/html&gt;
        ...
        <p id="9cb502e6-5bf1-474e-8fc6-d698a9f71681" class="">
        </p>
        ...
        <p id="eca50b40-3a48-4405-8045-c58010bd5cf6" class="">
        </p>
    ...
    function multiplyTwoNumbers(required numeric firstNum, required numeric secondNum){
        ...
        <p id="c5d95177-ee59-4548-ac8e-f072b387fa3d" class="">firstNum is required meaning that the function HAS to
            ...
            throw an error. </p>
        <p id="5c289be4-19c1-48be-82ee-253b2d37a142" class="">secondNum is the same as first num - required and
            numeric. </p>
        <p id="7f6234b0-dad5-4063-8893-5ef5f8ec2d1b" class="">return firstNum * secondNum <--- this means to multiply the
