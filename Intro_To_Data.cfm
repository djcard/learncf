...
<article id="47d25971-df7a-4114-94c4-e4c3df030016" class="page sans">
    ...
    <div class="page-body"><p id="493ed74e-bf3b-48d3-bf0b-d828c8752b29" class="">The whole focus of this class is
        ...
        by the controller level. No matter what the langauge, they need a connection between the server side script
        server and the database server. Each language creates this connection in its own way. ColdFusion does it by
        having the server manage &quot;datasources&quot;. Each datasource stores the location, user name, password and
        ...
        <p id="5ebc7c3b-4f6d-45dc-88cd-2cce543a5778" class="">Sorry, We couldn&#x27;t show your tables because
            datasource [%%SiteName%%] doesn&#x27;t exist</p>
        <p id="4919b4bf-1e91-4c13-8b1f-8a76484ded79" class="">Here are the fields in your books table dumped out:</p>
        <p id="776bb3eb-3f63-4a3b-ac06-2e84eac0ba55" class="">Sorry, We couldn&#x27;t show your tables because
            datasource [%%SiteName%%] doesn&#x27;t exist</p>
        ...
        <p id="fd6f77a5-5edf-4b5c-8b86-658ea8be6b33" class=""><strong>Exercise</strong>: Do the test your reading quiz
            and then let me know that I can look at your CF pages.</p></div>
</article>
</body>
</html>